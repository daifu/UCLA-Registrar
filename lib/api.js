...
API.prototype.getUserStarred = function(email, callback) {
   courses.findAllStarredByEmail(email, function(error, list){
      if (!error && list) {
         callback(null, list);
      } else {
         callback(error);
...
API.prototype.createUserStarred = function(email, term, sub, classid, callback) {
   courses.saveStarredByEmail(true, email, term, sub, classid, function(error, user){
      if (!error && user) {
         callback(null, user);
      } else {
         callback(error);
...
API.prototype.removeUserStarred = function(email, term, sub, classid, callback) {
   courses.saveStarredByEmail(false, email, term, sub, classid, function(error, user){
      if (!error && user) {
         callback(null, user);
      } else {
         callback(error);
